...
(function() {
     ...
     * @type {Object}
     */
    enchant.nineleap = { assets: ['/static/gallery/img/start.png', '/static/gallery/img/end.png'] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets['/static/gallery/img/start.png'];
                ...
                this.endScene.image = this.assets['si.png'];
